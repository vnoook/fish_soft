...
# нужно ли проверять на пустое значение в колонке "команда"? может ли там быть поле пустым?
# в "0 клубном расчёте" не нужно показывать колонки зон
# неправильно считается колонка "М ЛИЧ" если у спортиков одинаковые уловы
# делится ли расчёт на команды?
# делится ли расчёт на зоны?
# при нажатии на жеребьёвку с настройкой автозаполнения в клубном расчёте заполняются все колонки жеребьёвки, почему?
# переделать ввод команды, сделать чтобы были подсказки уже заполненных команд для быстрого выбора
# установить недоступность жеребьёвки после первого однократной жеребьёвке
# сделать автоматическую жеребьёвку в каждом периоде
